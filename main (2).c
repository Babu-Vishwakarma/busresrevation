...
void reservation(void)
{
	    ...
	    if(passdetails.bus_num>=533101 && passdetails.bus_num<=533105)
	    {
		        ...
		        printtickets(passdetails.name,passdetails.num_of_seats,passdetails.bus_num,charges);
	     }
	     else
	     {
...
void printtickets(char name[],int num_of_seats,int bus_num,float charges)
{
    system("cls");
	printf("-------------------\n");
	printf("\tTICKET\n");
